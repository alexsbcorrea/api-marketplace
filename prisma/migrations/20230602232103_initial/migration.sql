...
CREATE TABLE "products" (
    ...
    "price_promo" DECIMAL(65,30) NOT NULL,
    "image" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "permissions" ADD CONSTRAINT "permissions_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "colaborators" ADD CONSTRAINT "colaborators_adminId_fkey" FOREIGN KEY ("adminId") REFERENCES "admins"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "types_stores" ADD CONSTRAINT "types_stores_idColaborator_fkey" FOREIGN KEY ("idColaborator") REFERENCES "colaborators"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "specialities_stores" ADD CONSTRAINT "specialities_stores_idColaborator_fkey" FOREIGN KEY ("idColaborator") REFERENCES "colaborators"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
